#
# Get forest loss rasters
#
# Input:
#     Mapbiomas Bolivia
# Output:
#     Binary raster indicating a transition from forest to non-forest, annual
#

ParGetForestLoss <- function(raster_pair_path, out_folder) {
...
output_folder <- paste0(project_path, "data/constructed/raster/mapbiomas-transitions/forest-loss/")
