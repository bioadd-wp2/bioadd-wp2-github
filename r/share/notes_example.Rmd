...
- Top Left: forest gain - own calculation from MapBiomas Bolivia land cover maps
- Top Right: forest gain - Mapbiomas Bolivia transitions layer (same as above but with an additional spatial filter)
- Bottom Left: land cover
- Bottom Right: forest loss

These show rather noisy patterns

- Cannot discern any systematic differences between the two. Only the expected difference in magnitudes / extents.

<div>
  <input type="range" min="1" max="`r 36`" value="1" id="frameSlider2" step="1">
  ...
  <img src="images/el-torno/plot_el_torno_31.png" class="gifFrame" id="el-torno-frame31" style="display:none"> 
  <img src="images/el-torno/plot_el_torno_32.png" class="gifFrame" id="el-torno-frame32" style="display:none"> 
  <img src="images/el-torno/plot_el_torno_33.png" class="gifFrame" id="el-torno-frame33" style="display:none"> 
  <img src="images/el-torno/plot_el_torno_34.png" class="gifFrame" id="el-torno-frame34" style="display:none"> 
  <img src="images/el-torno/plot_el_torno_35.png" class="gifFrame" id="el-torno-frame35" style="display:none"> 
  <img src="images/el-torno/plot_el_torno_36.png" class="gifFrame" id="el-torno-frame36" style="display:none">
    ...
    function playAnimation(frameContainer, slider, speed=750){
        ...
        var playInterval = setInterval(() => {
            if (slider.value < numberOfFrames){
                ...
                clearInterval(playIntervalFrac10p);
            }
        }, speed);
        return playInterval;
    }
