...
types = ['national', 'state', 'municipal']

for type in types:

    r_path = project_path + 'data/constructed/raster/protected-areas-cohort/' + type + '.tif'
    ...
    for year in years:
        ...
        out_folder = 'D:/bioadd-wp2/data/constructed/raster/distances/protected-area-cohort/' + type + '/'
        ...
        params = {
                ...
                'MAX_DISTANCE': 10000, # Max distance
